...
Check our other articles if you're interested in a similar guide for Python, and for more articles about R!

# 1. Structure of the Data

```{r A simple data structure}
# we need some data! 
...
```{r  Starter Plot, fig.height=5, fig.width=4,fig.align='center'}
...
```{r  Actual Data Plot, fig.height=5, fig.width=4,fig.align='center'}
...
```{r  Combined Plot, fig.height=5, fig.width=4,fig.align='center'}
...
```{r Customised Plot, fig.height=5, fig.width=4,fig.align='center'}
...
```{r Simple Test, fig.height=4, fig.width=3}
t.test(extra~group, 
...
```{r Save Test, fig.height=5, fig.width=4,fig.align='center'}
